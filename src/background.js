  ...
  ;(function (scope) {
    ...
    function run(state) {
      ...
      function toggleHotkeyGroup(group) {
        ...
        scope.chrome.storage.session.set({
          hotKeyGroupData: { enabledHotkeyGroup }
        })
